...
import com.diplomski.onlinemarketing.dto.request.UserResponse;
import com.diplomski.onlinemarketing.dto.response.UserRequest;
...
@RestController
@RequestMapping("/user")
public class UserController extends GenericController<UserResponse, UserRequest, User, Long> {
